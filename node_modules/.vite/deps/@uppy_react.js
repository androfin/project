...
function Header(props) {
  var _a;
  return u("div", { className: "uppy-ProviderBrowser-header", children: u("div", { className: (0, import_classnames4.default)("uppy-ProviderBrowser-headerBar", !props.showBreadcrumbs && "uppy-ProviderBrowser-headerBar--simple"), children: [props.showBreadcrumbs && u(Breadcrumbs, { openFolder: props.openFolder, breadcrumbs: props.breadcrumbs, breadcrumbsIcon: (_a = props.pluginIcon) == null ? void 0 : _a.call(props), title: props.title, i18n: props.i18n }), u(User, { logout: props.logout, username: props.username, i18n: props.i18n })] }) });
}
...
var _abortController, _ProviderView_instances, withAbort_fn, search_fn, _searchDebounced, renderSearchResults_fn;
var ProviderView = class {
  constructor(plugin, opts) {
    ...
    __privateAdd(this, _searchDebounced, (0, import_debounce.default)(__privateMethod(this, _ProviderView_instances, search_fn), 500));
    __publicField(this, "onSearchInput", (s2) => {
  ...
  render(state, viewOptions = {}) {
    ...
    }, inputLabel: i18n("filter"), clearSearchLabel: i18n("resetFilter"), wrapperClassName: "uppy-ProviderBrowser-searchFilter", inputClassName: "uppy-ProviderBrowser-searchFilterInput" }), searchResults ? __privateMethod(this, _ProviderView_instances, renderSearchResults_fn).call(this) : u(Browser_default, { toggleCheckbox: this.toggleCheckbox, displayedPartialTree: this.getDisplayedPartialTree(), openFolder: this.openFolder, virtualList: opts.virtualList, noResultsLabel: i18n("noFilesFound"), handleScroll: this.handleScroll, viewType: opts.viewType, showTitles: opts.showTitles, i18n: this.plugin.uppy.i18n, isLoading: loading, utmSource: "Companion" }), u(FooterActions, { partialTree, donePicking: this.donePicking, cancelSelection: this.cancelSelection, i18n, validateAggregateRestrictions: this.validateAggregateRestrictions })] });
  }
};
...
__publicField(ProviderView, "VERSION", package_default.version);
...
__publicField(SearchProviderView, "VERSION", package_default.version);
...
var w = t.fetch;
function k2(e2, t2) {
  return (i2 = e2).startsWith("data:") || i2.length > 1e4 ? v(e2, t2, "base64") : n && e2.includes("://") ? O(e2, t2, "url", S) : n ? v(e2, t2, "fs") : s ? O(e2, t2, "url", S) : void l2("Invalid input argument");
  var i2;
}
async function O(e2, t2, s2, i2) {
  return b2.has(s2) ? v(e2, t2, s2) : i2 ? async function(e3, t3) {
    let s3 = await t3(e3);
    return new c(s3);
  }(e2, i2) : void l2(`Parser ${s2} is not loaded`);
}
...
var D = class extends _2 {
  ...
  constructor(t2, s2, i2, n2) {
    ...
    } else true === i2 || false === i2 ? this.parse = this.enabled = i2 : l2(`Invalid options argument: ${i2}`);
  }
...
var H2 = class {
  ...
  async read(e2) {
    this.file = await function(e3, t2) {
      return "string" == typeof e3 ? k2(e3, t2) : s && !i && e3 instanceof HTMLImageElement ? k2(e3.src, t2) : e3 instanceof Uint8Array || e3 instanceof ArrayBuffer || e3 instanceof DataView ? new c(e3) : s && e3 instanceof Blob ? O(e3, t2, "blob", A2) : void l2("Invalid input argument");
    }(e2, this.options);
  }
  setup() {
...
var J = class {
  ...
  translateBlock(e2, t2) {
    let s2 = I.get(t2), i2 = V.get(t2), n2 = B.get(t2), r2 = this.options[t2], a2 = r2.reviveValues && !!s2, h5 = r2.translateValues && !!i2, f2 = r2.translateKeys && !!n2, l3 = {};
    for (let [t3, r3] of e2) a2 && s2.has(t3) ? r3 = s2.get(t3)(r3) : h5 && i2.has(t3) && (r3 = this.translateValue(r3, i2.get(t3))), f2 && n2.has(t3) && (t3 = n2.get(t3) || t3), l3[t3] = r3;
    return l3;
  }
...
var ee = class extends class {
  ...
  findAppSegmentsInRange(e2, t2) {
    t2 -= 2;
    let s2, i2, n2, r2, a2, h5, { file: f2, findAll: l3, wanted: o2, remaining: u3, options: d3 } = this;
    for (; e2 < t2; e2++) if (255 === f2.getUint8(e2)) {
      if (s2 = f2.getUint8(e2 + 1), Q(s2)) {
        if (i2 = f2.getUint16(e2 + 2), n2 = Z(f2, e2, i2), n2 && o2.has(n2) && (r2 = y2.get(n2), a2 = r2.findPosition(f2, e2), h5 = d3[n2], a2.type = n2, this.appSegments.push(a2), !l3 && (r2.multiSegment && h5.multiSegment ? (this.unfinishedMultiSegment = a2.chunkNumber < a2.chunkCount, this.unfinishedMultiSegment || u3.delete(n2)) : u3.delete(n2), 0 === u3.size))) break;
...
var se = class extends J {
  ...
  parseTags(e2, t2, s2 = /* @__PURE__ */ new Map()) {
    ...
    i2 = new Set(i2);
    let r2 = i2.size > 0, a2 = 0 === n2.size, h5 = this.chunk.getUint16(e2);
    e2 += 2;
    for (let f2 = 0; f2 < h5; f2++) {
      let h6 = this.chunk.getUint16(e2);
      if (r2) {
        if (i2.has(h6) && (s2.set(h6, this.parseTag(e2, h6, t2)), i2.delete(h6), 0 === i2.size)) break;
      } else !a2 && n2.has(h6) || s2.set(h6, this.parseTag(e2, h6, t2));
      e2 += 12;
    }
    return s2;
  }
  parseTag(e2, t2, s2) {
    ...
    if (a2 * r2 <= 4 ? e2 += 8 : e2 = i2.getUint32(e2 + 8), (n2 < 1 || n2 > 13) && l2(`Invalid TIFF value type. block: ${s2.toUpperCase()}, tag: ${t2.toString(16)}, type: ${n2}, offset ${e2}`), e2 > i2.byteLength && l2(`Invalid TIFF value offset. block: ${s2.toUpperCase()}, tag: ${t2.toString(16)}, type: ${n2}, offset ${e2} is outside of chunk size ${i2.byteLength}`), 1 === n2) return i2.getUint8Array(e2, r2);
    if (2 === n2) return "" === (h5 = function(e3) {
      for (; e3.endsWith("\0"); ) e3 = e3.slice(0, -1);
      return e3;
    }(h5 = i2.getString(e2, r2)).trim()) ? void 0 : h5;
    var h5;
...
__publicField(ThumbnailGenerator, "VERSION", package_default2.version);
...
var Dashboard2 = class extends UIPlugin_default {
  ...
  setOptions(opts) {
    ...
    (_a = this.uppy.getPlugin(__privateMethod(this, _Dashboard_instances, getThumbnailGeneratorId_fn).call(this))) == null ? void 0 : _a.setOptions(__privateMethod(this, _Dashboard_instances, getThumbnailGeneratorOpts_fn).call(this));
  }
};
...
__publicField(Dashboard2, "VERSION", package_default3.version);
...
function createDropzone(ctx, options = {}) {
  ...
  return {
    ...
    getInputProps: () => {
      ...
      const accept = (_a = restrictions.allowedFileTypes) == null ? void 0 : _a.join(", ");
      return {
        id: fileInputId,
        type: "file",
...
function FilesList(props) {
  ...
  return u("ul", { "data-uppy-element": "files-list", className: "uppy-reset uppy:my-4", children: files == null ? void 0 : files.map((file) => {
    var _a, _b, _c;
    return u("li", { children: u(k, { children: [u("div", { className: "uppy:flex uppy:items-center uppy:gap-2", children: [u("div", { className: "uppy:w-[32px] uppy:h-[32px]", children: u(Thumbnail, { width: "32px", height: "32px", file, images: imageThumbnail }) }), u("p", { className: "uppy:truncate", children: file.name }), u("p", { className: "uppy:text-gray-500 uppy:tabular-nums uppy:min-w-18 uppy:text-right uppy:ml-auto", children: prettyBytes(file.size || 0) }), u(k, { children: [editFile && u("button", { type: "button", className: "uppy:flex uppy:rounded uppy:text-blue-500 uppy:hover:text-blue-700 uppy:bg-transparent uppy:transition-colors", onClick: () => {
      editFile(file);
    }, children: "edit" }), u("button", { type: "button", className: "uppy:flex uppy:rounded uppy:text-blue-500 uppy:hover:text-blue-700 uppy:bg-transparent uppy:transition-colors", onClick: () => {
      var _a2;
...
function createFileInput(ctx, props = {}) {
  ...
  return {
    getInputProps: () => {
      ...
      accept ?? (accept = allowedFileTypes == null ? void 0 : allowedFileTypes.join(", "));
...
(N2.prototype = new x()).isPureReactComponent = true, N2.prototype.shouldComponentUpdate = function(n2, t2) {
  return E2(this.props, n2) || E2(this.state, t2);
};
var T3 = l.__b;
l.__b = function(n2) {
...
l.__e = function(n2, t2, e2, r2) {
  if (n2.then) {
    for (var u3, o2 = t2; o2 = o2.__; ) if ((u3 = o2.__c) && u3.__c) return null == t2.__e && (t2.__e = e2.__e, t2.__k = e2.__k), u3.__c(n2, t2);
  }
  F3(n2, t2, e2, r2);
};
var U2 = l.unmount;
function V2(n2, t2, e2) {
  return n2 && (n2.__c && n2.__c.__H && (n2.__c.__H.__.forEach(function(n3) {
    "function" == typeof n3.__c && n3.__c();
  }), n2.__c.__H = null), null != (n2 = g3({}, n2)).__c && (n2.__c.__P === e2 && (n2.__c.__P = t2), n2.__c.__e = true, n2.__c = null), n2.__k = n2.__k && n2.__k.map(function(n3) {
    return V2(n3, t2, e2);
  })), n2;
}
function W2(n2, t2, e2) {
...
l.unmount = function(n2) {
  var t2 = n2.__c;
  t2 && t2.__R && t2.__R(), t2 && 32 & n2.__u && (n2.type = null), U2 && U2(n2);
}, (P3.prototype = new x()).__c = function(n2, t2) {
  var e2 = t2.__c, r2 = this;
  null == r2.o && (r2.o = []), r2.o.push(e2);
  var u3 = j2(r2.__v), o2 = false, i2 = function() {
    o2 || (o2 = true, e2.__R = null, u3 ? u3(l3) : l3());
  };
  e2.__R = i2;
  var l3 = function() {
    if (!--r2.__u) {
      if (r2.state.__a) {
        var n3 = r2.state.__a;
        r2.__v.__k[0] = W2(n3, n3.__c.__P, n3.__c.__O);
      }
      var t3;
  ...
  this.o = [];
}, P3.prototype.render = function(n2, e2) {
  if (this.__b) {
    if (this.__v.__k) {
      var r2 = document.createElement("div"), o2 = this.__v.__k[0].__c;
      this.__v.__k[0] = V2(this.__b, r2, o2.__O = o2.__P);
    }
    this.__b = null;
  }
  var i2 = e2.__a && _(k, null, n2.fallback);
  return i2 && (i2.__u &= -33), [_(k, null, e2.__a ? null : n2.children), i2];
};
var H3 = function(n2, t2, e2) {
...
(B2.prototype = new x()).__a = function(n2) {
  var t2 = this, e2 = j2(t2.__v), r2 = t2.l.get(n2);
  return r2[0]++, function(u3) {
    var o2 = function() {
      t2.props.revealOrder ? (r2.push(u3), H3(t2, n2, r2)) : u3();
    };
    e2 ? e2(o2) : o2();
  };
...
function nn(n2, t2, e2) {
  return null == t2.__k && (t2.textContent = ""), G(n2, t2), "function" == typeof e2 && e2(), n2 ? n2.__c : null;
}
...
l.vnode = function(n2) {
  "string" == typeof n2.type && function(n3) {
    var t2 = n3.props, e2 = n3.type, u3 = {}, o2 = -1 === e2.indexOf("-");
    for (var i2 in t2) {
      var l3 = t2[i2];
      if (!("value" === i2 && "defaultValue" in t2 && null == l3 || Q3 && "children" === i2 && "noscript" === e2 || "class" === i2 || "className" === i2)) {
        var c2 = i2.toLowerCase();
        "defaultValue" === i2 && "value" in t2 && null == t2.value ? i2 = "value" : "download" === i2 && true === l3 ? l3 = "" : "translate" === c2 && "no" === l3 ? l3 = false : "o" === c2[0] && "n" === c2[1] ? "ondoubleclick" === c2 ? i2 = "ondblclick" : "onchange" !== c2 || "input" !== e2 && "textarea" !== e2 || X2(t2.type) ? "onfocus" === c2 ? i2 = "onfocusin" : "onblur" === c2 ? i2 = "onfocusout" : J3.test(i2) && (i2 = c2) : c2 = i2 = "oninput" : o2 && G3.test(i2) ? i2 = i2.replace(K3, "-$&").toLowerCase() : null === l3 && (l3 = void 0), "oninput" === c2 && u3[i2 = c2] && (i2 = "oninputCapture"), u3[i2] = l3;
      }
    }
    "select" == e2 && u3.multiple && Array.isArray(u3.value) && (u3.value = H(t2.children).forEach(function(n4) {
      n4.props.selected = -1 != u3.value.indexOf(n4.props.value);
    })), "select" == e2 && null != u3.defaultValue && (u3.value = H(t2.children).forEach(function(n4) {
      n4.props.selected = u3.multiple ? -1 != u3.defaultValue.indexOf(n4.props.value) : u3.defaultValue == n4.props.value;
    })), t2.class && !t2.className ? (u3.class = t2.class, Object.defineProperty(u3, "className", cn)) : (t2.className && !t2.class || t2.class && t2.className) && (u3.class = u3.className = t2.className), n3.props = u3;
