...
function fetcher(url, options = {}) {
  ...
  const delay2 = (attempt) => 0.3 * 2 ** (attempt - 1) * 1e3;
...
function I(n2, l3, u4, t3, i4, r3, o3, e3, f4, c3, s3) {
  ...
  for (f4 = P(u4, l3, m3, f4, b2), a3 = 0; a3 < b2; a3++) null != (y3 = u4.__k[a3]) && (h3 = -1 == y3.__i ? p : m3[y3.__i] || p, y3.__i = a3, g2 = O(n2, y3, h3, i4, r3, o3, e3, f4, c3, s3), w3 = y3.__e, y3.ref && h3.ref != y3.ref && (h3.ref && B(h3.ref, null, y3), s3.push(y3.ref, y3.__c || w3, y3)), null == d3 && null != w3 && (d3 = w3), (_2 = !!(4 & y3.__u)) || h3.__k === y3.__k ? f4 = A(y3, f4, n2, _2) : "function" == typeof y3.type && void 0 !== g2 ? f4 = g2 : w3 && (f4 = w3.nextSibling), y3.__u &= -7);
  return u4.__e = d3, f4;
}
...
addListeners_fn = function() {
  ...
  this.on("postprocess-complete", (fileIn) => {
    ...
    if (file == null) {
      this.log(`Not setting progress for a file that has been removed: ${fileIn == null ? void 0 : fileIn.id}`);
      return;
    }
...
@uppy/utils/lib/Translator.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CBPIEH2G.js.map
